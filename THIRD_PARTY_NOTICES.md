...
- Versión integrada: `v1.0.2-stable`.
- Licencia: MIT.
- Copia local: `addons/terrain_3d/LICENSE.txt`.

El addon se distribuye dentro de `addons/terrain_3d`. El terreno, las escenas y los scripts específicos del juego no proceden de su demo.

## Quaternius — dirección visual activa

Todos los siguientes packs se publican bajo [CC0 1.0 Universal](https://creativecommons.org/publicdomain/zero/1.0/) y pueden utilizarse en proyectos personales y comerciales:
...
- [Rock 063](https://ambientcg.com/view?id=Rock063): laderas rocosas.
...
## FiftySounds — música activa

- Archivos integrados: `assets/music/The Hill that Knows your Voice.mp3`, `assets/music/Promise - nieve.mp3` y `assets/music/Ashes-desierto.mp3`.
...
> **Obras: La Colina que Conoce tu Voz, Promise y Ashes**
>
> **Música de https://www.fiftysounds.com/es/**

Esta misma atribución aparece dentro del juego al pulsar `0`.

## Contenido original

Los cinco tiles estilizados de terreno —incluidas arena y nieve low-poly—, el viento, los pájaros y los cascos son contenido original del proyecto. Las tres canciones de FiftySounds indicadas arriba son contenido de terceros con atribución. La antigua cascada, su agua y su audio han sido eliminados.
